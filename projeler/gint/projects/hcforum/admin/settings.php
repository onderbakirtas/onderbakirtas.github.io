...
if (isset($_POST['form_sent']))
{
	...
	switch ($section)
	{
		case 'setup':
		{
			...
			// Check if logo field is blank
			if (empty($form['board_logo']))
				$form['board_logo'] = $forum_config['o_board_logo'];

			// Clean default_lang, default_style, and sef
            $form['board_logo'] = "../img/" . $form['board_logo'];
...
<?php ($hook = get_hook('aop_setup_pre_board_logo')) ? eval($hook) : null; ?>
                    <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
                        <div class="sf-box text">
                            <label for="fld<?php echo ++$forum_page['fld_count'] ?>">
                                <span><?php echo $lang_admin_settings['Board logo label'] ?></span>
                                <small><?php echo $lang_admin_settings['Board logo help']; ?></small>
                            </label><br />
                            <span class="fld-input"><input type="file" id="fld<?php echo $forum_page['field_count'] ?>" name="form[board_logo]" /></span>
                        </div>
                    </div>
