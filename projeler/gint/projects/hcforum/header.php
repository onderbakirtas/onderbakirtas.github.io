...
// Forum Title
$gen_elements['<!-- forum_title -->'] = '<p id="brd-title"><a href="'.forum_link($forum_url['index']).'"><img src="'.FORUM_ROOT."/img/".$forum_config['o_board_logo'].'" alt="Hazard Course Forums"></a></p>';
